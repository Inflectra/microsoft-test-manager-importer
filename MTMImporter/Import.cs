...
namespace Inflectra.SpiraTest.AddOns.MTMImporter
{
	...
	public class ImportForm : System.Windows.Forms.Form
	{
        ...
        public const string API_PLUGIN_NAME = "MTMImporter";
        ...
        /// <param name="e"></param>
        void spiraImportExport_Connection_Authenticate2Completed(object sender, SpiraImportExport.Connection_Authenticate2CompletedEventArgs e)
        {
